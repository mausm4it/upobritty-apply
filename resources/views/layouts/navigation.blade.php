        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    ...
                    <span class="h-12 w-12 rounded-full mt-5 ">
                        <img width="50" src="{{ asset('public/frontend/logo/upbriity logo_white.svg') }}"
                            alt="User" />
                    </span>

                    <svg :class="dropdownOpen && 'rotate-180'" class="hidden fill-current sm:block mr-5 " width="12"
