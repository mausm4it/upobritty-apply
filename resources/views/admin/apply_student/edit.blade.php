...
<div class="flex items-center justify-center ">
    ...
    <div class="mx-auto w-full  p-9 mt-5 mb-3 bg-white">
        ...
        <form action="{{route('update_student_apply', $student_apply->id )}}" method="POST"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                value="{{ old('birth_date_number', $student_apply->birth_date_number) }}"
                                id="birth_date_number" oninput="limitLength(this)" required />
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="national_id_number" id="national_id_number"
                                value="{{ old('national_id_number', $student_apply->national_id_number) }}"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <select id="religion" name="religion"
                                ...
                                <option value="ইসলাম" {{ old('religion', $student_apply->religion)=='ইসলাম' ? 'selected'
                                    : '' }}>ইসলাম
                                </option>
                                <option value="হিন্দু ধর্ম" {{ old('religion', $student_apply->religion)=='হিন্দু ধর্ম'
                                    ? 'selected' : '' }}>
                                    হিন্দু ধর্ম</option>
                                <option value="বৌদ্ধ ধর্ম" {{ old('religion', $student_apply->religion)=='বৌদ্ধ ধর্ম' ?
                                    'selected' : '' }}>
                                    বৌদ্ধ ধর্ম</option>
                                <option value="খ্রিস্টধর্ম" {{ old('religion', $student_apply->religion)=='খ্রিস্টধর্ম'
                                    ? 'selected' : '' }}>
                                    খ্রিস্টধর্ম</option>
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <select id="gender" name="gender"
                                ...
                                <option value="পুরুষ" {{ old('gender', $student_apply->gender)=='পুরুষ' ? 'selected' :
                                    '' }}>পুরুষ</option>
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <select id="marital_status" name="marital_status"
                                ...
                                <option value="অবিবাহিত" {{ old('marital_status', $student_apply->
                                    marital_status)=='অবিবাহিত' ? 'selected' : '' }}>
                                    অবিবাহিত </option>
                                <option value="বিবাহিত" {{ old('marital_status', $student_apply->
                                    marital_status)=='বিবাহিত' ? 'selected' : '' }}>
                                    বিবাহিত</option>
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="partner_name" placeholder=" স্ত্রীর নাম লিখুন"
                                value="{{ old('partner_name', $student_apply->partner_name) }}"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            @error('partner_name')
                            <div class=" text-red-500">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="email" name="email" placeholder="আপনার ইমেইল ঠিকানা লিখুন"
                                value="{{ old('email', $student_apply->email) }}"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                            @error('email')
                            <div class=" text-red-500">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <select id="minorities" name="minorities"
                                ...
                                <option value="হ্যাঁ" {{ old('minorities', $student_apply->minorities)=='হ্যাঁ' ?
                                    'selected' : '' }}>হ্যাঁ
                                </option>
                                <option value="না" {{ old('minorities', $student_apply->minorities)=='না' ? 'selected' :
                                    '' }}>না</option>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <select id="freedom_fighter" name="freedom_fighter"
                                        ...
                                        required>
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="হ্যাঁ" {{ old('freedom_fighter', $student_apply->
                                            freedom_fighter)=='হ্যাঁ' ? 'selected' : '' }}>
                                            হ্যাঁ </option>
                                        <option value="না" {{ old('freedom_fighter', $student_apply->
                                            freedom_fighter)=='না' ? 'selected' : '' }}>
                                            না</option>
                                    </select>
            ...
            <div class="border border-blue-300 rounded-lg p-5 mb-5">
                ...
                <div class="w-full">
                    <div class="mb-5">
                        ...
                        <textarea name="home_no"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">{{ old('home_no', $student_apply->home_no) }}</textarea>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <select id="exam_name" name="exam_name"
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                        required>
                                        <option value="এস.এস.সি/দাখিল/সমমান" {{ old('exam_name', $student_apply->
                                            exam_name)=='এস.এস.সি/দাখিল/সমমান'
                                            ? 'selected' : '' }}>
                                            এস.এস.সি/দাখিল/সমমান</option>
                                        <option value="এইচ.এস.সি/আলিম/সমমান" {{ old('exam_name', $student_apply->
                                            exam_name)=='এইচ.এস.সি/আলিম/সমমান'
                                            ? 'selected' : '' }}>
                                            এইচ.এস.সি/আলিম/সমমান</option>
                                        <option value="অনার্স/ফাজিল/সমমান" {{ old('exam_name', $student_apply->
                                            exam_name)=='অনার্স/ফাজিল/সমমান'
                                            ? 'selected' : '' }}>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <select id="board_name" name="board_name"
                                        ...
                                        <option value="যশোর" {{ old('board_name', $student_apply->board_name)=='যশোর' ?
                                            'selected' : '' }}>
                                            যশোর</option>
                                        <option value="চট্টগ্রাম" {{ old('board_name', $student_apply->
                                            board_name)=='চট্টগ্রাম' ? 'selected' : ''
                                            }}>চট্টগ্রাম</option>
                                        <option value="ঢাকা" {{ old('board_name', $student_apply->board_name)=='ঢাকা' ?
                                            'selected' : '' }}>
                                            ঢাকা</option>
                                        <option value="রাজশাহী" {{ old('board_name', $student_apply->
                                            board_name)=='রাজশাহী' ? 'selected' : '' }}>
                                            রাজশাহী</option>
                                        <option value="কুমিল্লা" {{ old('board_name', $student_apply->
                                            board_name)=='কুমিল্লা' ? 'selected' : '' }}>
                                            কুমিল্লা</option>
                                        <option value="বরিশাল" {{ old('board_name', $student_apply->
                                            board_name)=='বরিশাল' ? 'selected' : '' }}>
                                            বরিশাল</option>
                                        <option value="সিলেট" {{ old('board_name', $student_apply->board_name)=='সিলেট'
                                            ? 'selected' : '' }}>
                                            সিলেট</option>
                                        <option value="দিনাজপুর" {{ old('board_name', $student_apply->
                                            board_name)=='দিনাজপুর' ? 'selected' : '' }}>
                                            দিনাজপুর</option>
                                        <option value="ময়মনসিংহ" {{ old('board_name', $student_apply->
                                            board_name)=='ময়মনসিংহ' ? 'selected' : '' }}>
                                            ময়মনসিংহ</option>
                                        <option value="মাদ্রাসা" {{ old('board_name', $student_apply->
                                            board_name)=='মাদ্রাসা' ? 'selected' : '' }}>
                                            মাদ্রাসা</option>
                                        <option value="কারিগরি শিক্ষা" {{ old('board_name', $student_apply->
                                            board_name)=='কারিগরি শিক্ষা'
                                            ? 'selected' : '' }}>কারিগরি
                                            শিক্ষা</option>
                                    </select>
                                    @error('board_name')
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <select id="result_type" name="result_type"
                                        ...
                                        required>
                                        <option value="">নির্বাচন করুন</option>
                                        <option value="জি পি এ" {{ old('result_type', $student_apply->result_type)=='জি
                                            পি এ' ? 'selected' : '' }}>জি
                                            পি এ (5.00 এর
                                            মধ্যে)</option>
                                        <option value="সি জি পি এ" {{ old('result_type', $student_apply->
                                            result_type)=='সি জি পি এ' ? 'selected' : ''
                                            }}>সি জি পি এ (4.00
                                            এর মধ্যে)</option>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="result" id="result" placeholder="ফলাফল লিখুন"
                                        value="{{ old('result', $student_apply->result) }}"
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                        required />
                                    @error('result')
                                    <div class=" text-red-500">{{ $message }}</div>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="passing_year" id="passing_year"
                                        value="{{ old('passing_year', $student_apply->passing_year) }}"
                                        placeholder="পাশ এর বছর লিখুন"
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                        required />
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="father_bangla_name" id="father_bangla_name"
                                value="{{ old('father_bangla_name', $student_apply->father_bangla_name) }}"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="father_english_name" id="father_english_name"
                                value="{{ old('father_english_name', $student_apply->father_english_name) }}"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="mother_bangla_name" id="mother_bangla_name"
                                value="{{ old('mother_bangla_name', $student_apply->mother_bangla_name) }}"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="mother_english_name" id="mother_english_name"
                                value="{{ old('mother_english_name', $student_apply->mother_english_name) }}"
                                oninput="limitLength(this)" placeholder=" আবেদনকারীর মাতার লিখুন বাংলায়"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                required />
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="father_national_id_number" id="father_national_id_number"
                                value="{{ old('father_national_id_number', $student_apply->father_national_id_number) }}"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="mother_national_id_number" id="mother_national_id_number"
                                value="{{ old('mother_national_id_number', $student_apply->mother_national_id_number) }}"
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        ...
                        <div class="mb-5">
                            ...
                            <select id="guardian" name="guardian"
                                ...
                                required>
                                <option value="">নির্বাচন করুন</option>
                                <option value="বাবা" {{ old('guardian', $student_apply->guardian)=='বাবা' ? 'selected' :
                                    '' }}>বাবা
                                </option>
                                <option value="মা" {{ old('guardian', $student_apply->guardian)=='মা' ? 'selected' : ''
                                    }}>মা</option>
                                <option value="অন্য অভিভাবক" {{ old('guardian', $student_apply->guardian)=='অন্য
                                    অভিভাবক' ? 'selected' : '' }}>
                                    অন্য অভিভাবক</option>
                            </select>
                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="guardian_name_national_id_number"
                                ...
                                value="{{ old('guardian_name_national_id_number', $student_apply->guardian_name_national_id_number) }}"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                ...
                <div class="w-full">
                    <div class="mb-5">
                        ...
                        <textarea name="guardian_address"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">{{ old('guardian_address', $student_apply->guardian_address) }}</textarea>
