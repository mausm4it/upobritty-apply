...
<div class="flex items-center justify-center ">
    ...
    <div class="mx-auto w-full  p-9 mt-5 mb-3 bg-white">
        ...
        <form action="{{route('home_card_update', $home_card->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="w-full px-3">
                        <div class="mb-5">
                            ...
                            <input type="text" name="card_name" id="card_name"
                                value="{{ old('card_name',$home_card->card_name) }}" placeholder="Write Home Card name"
                        ...
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input onchange="ProfileImage(event)"
                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                    type="file" name="card_image" accept="image/*"
                                    value="{{ old('card_name',$home_card->card_image) }}">
                                @error('card_image')
