    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary"> Home Card List</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
            ...
            <div class="data-table-common data-table-one max-w-full overflow-x-auto">
                ...
                <table class="table w-full table-auto" id="dataTableOne">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <img width="80" src="{{asset('storage/app/'.$item->card_image)}}"
                                    alt="{{$item->card_name}}">
                            </td>
                            ...
                            <td>
                                ...
                                <form class="text-center" action="{{ route('update_home_card_status', $item->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <td>
                                <div class="flex items-center text-center space-x-3.5">
                                    ...
                                    <a href="{{route('home_card_edit', $item->id)}}" class="hover:text-primary">
                                    ...
                                    <a href="{{route('home_card_delete', $item->id)}}" class="hover:text-primary">
                                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
