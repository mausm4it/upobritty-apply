                ...
                <div class="w-full px-3">
                    <div class="mb-5">
                        ...
                        <textarea rows="6" id="page_details" name="page_details" placeholder="Default textarea"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">{{old('page_details')}}</textarea>
