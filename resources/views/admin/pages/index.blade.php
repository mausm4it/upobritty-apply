    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary"> Pages List</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center text-center space-x-3.5">
                                    ...
                                    <a href="{{route('page_edit_view', $item->id)}}" class="hover:text-primary">
                                    ...
                                    <a href="{{route('page_delete', $item->id)}}" class="hover:text-primary">
                                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
