  ...
  <div class="flex flex-col gap-5 md:gap-7 2xl:gap-10">
        ...
        <table class="table w-full table-auto" id="dataTableOne">
          ...
          <thead>
            <tr>
              ...
              <th>
                <div class="flex items-center gap-1.5">
                  <p class="text-xs">Payment Number</p>
                  <div class="inline-flex flex-col space-y-[2px]">
                    <span class="inline-block">
                      <svg class="fill-current" width="10" height="5" viewBox="0 0 10 5" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{route('show_student_apply', $item->id)}}">
                  {{$item->engish_name}}
                </a></td>
              <td><a href="{{route('show_student_apply', $item->id)}}">
                  {{$item->phone_number}}
              ...
              <td>
                ...
                <form id="myForm" class="text-center" action="{{ route('updatePaymentStatus', $item->id) }}"
                  method="POST">
                  @csrf
                  @method('PUT')
    ...
    <script>
      document.getElementById('download').addEventListener('click', function() {
            let csv = 'Student ID,Name,Phone,Education,Payment Number,Payment Status, Status\n';
            document.querySelectorAll('#dataTableOne tbody tr').forEach(row => {
                const cells = row.querySelectorAll('td');
                csv +=
                    `${cells[0].innerText},${cells[1].innerText},${cells[2].innerText},${cells[3].innerText},${cells[4].innerText},${cells[5].innerText},${cells[6].innerText},${cells[7].innerText}\n`;
            });
