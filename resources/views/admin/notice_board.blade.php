    ...
    <div class="mx-auto max-w-5xl">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Notice List</li>
                </ol>
            </nav>
        </div>
        <!-- Breadcrumb End -->
        ...
        <div class="mt-5 flex flex-col gap-9">
            ...
            <div class="swim-lane flex flex-col gap-5.5">
                ...
                <div draggable="true"
                    class="task relative flex cursor-move justify-between rounded-sm border border-stroke bg-white p-3 shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <div class="absolute right-4 top-4">
                        <div x-data="{openDropDown: false}" class="relative">
                            ...
                            <div x-show="openDropDown" @click.outside="openDropDown = false"
                                ...
                                <a href="{{route('delete_notice', $item->id)}}"
                                    class="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
                                    <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
