                    ...
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input
                                ...
                                value="{{ old('nid_number') }}" id="nid_number" oninput="limitLength(this)" required />
                            @error('nid_number')
                            <div class=" text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <select id="exam_name" name="exam_name"
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                        required>
                                        <option value="মাধ্যমিক/সমমান" {{ old('exam_name')=='মাধ্যমিক/সমমান'
                                            ? 'selected' : '' }}>
                                            মাধ্যমিক/সমমান</option>
                                        <option value="উচ্চমাধ্যমিক/সমমান" {{ old('exam_name')=='উচ্চমাধ্যমিক/সমমান'
                                            ? 'selected' : '' }}>
                                            উচ্চমাধ্যমিক/সমমান</option>
                                        <option value="স্নাতক/সমমান" {{ old('exam_name')=='স্নাতক/সমমান' ? 'selected'
                                            : '' }}>
                                            স্নাতক/সমমান</option>
                                    </select>
                            ...
                            <div class="w-full px-3 sm:w-1/2">
                                <div class="mb-5">
                                    ...
                                    <input onchange="ProttoyonImage(event)" value="{{ old('prottoyon_potro') }}"
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                        type="file" name="prottoyon_potro" value="{{old('prottoyon_potro')}}" required>
                                    ...
                                    <div class="mb-5">
                                        <div>
                                            ...
                                            <input type="file" name="minorities_document"
                                                value="{{ old('minorities_document') }}" id="minorities_document"
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                    ...
                                    <div class="mb-5">
                                        <div>
                                            ...
                                            <input type="file" name="otizom_document"
                                                value="{{ old('otizom_document') }}" id="otizom_document"
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
